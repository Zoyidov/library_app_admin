...
import 'package:library_app_admin/features/auth/presentation/manager/register/register_cubit.dart';
      ...
      child: BlocListener<RegisterCubit, RegisterState>(
        listener: (context, state) {
          ...
          if (state.status.isSuccess) {
            ...
            // TODO: get library information from database if not exist push to library information screen
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => const LibraryInformationScreen()));
          }
